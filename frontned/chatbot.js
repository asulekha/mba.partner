/* ============================================================
   ...
   Used by: mba-partner-home.html, mba-partner-cat-omet-home.html
...
/* ---------------------------------------------------------------
   ...
   Add as many entries as you want. Each entry needs:
...
const KNOWLEDGE_BASE = {
    cat: [
        ...
        {
            keywords: ['reading comprehension', 'rc tips'],
        ...
        {
            keywords: ['bar graph', 'pie chart', 'table', 'di'],
        ...
        // Quant
        {
            keywords: ['quant', 'quantitative', 'quantitative aptitude', 'qa'],
        ...
        {
            keywords: ['arithmetic', 'percentage', 'profit loss', 'ratio'],
        ...
        // Time management
        {
            keywords: ['time management', 'time in exam'],
        ...
        // IIM specific
        {
            keywords: ['iim ahmedabad', 'iim a', 'iima'],
        ...
        {
            keywords: ['iim bangalore', 'iim b', 'iimb'],
        ...
        {
            keywords: ['iim calcutta', 'iim c', 'iimc'],
        ...
        {
            keywords: ['iim lucknow', 'iim l', 'iiml'],
        ...
        {
            keywords: ['iim kozhikode', 'iim k', 'iimk'],
        ...
        // GDPI
        {
            ...
            answer: 'GDPI (Group Discussion + Personal Interview) is the final selection round after written exam shortlisting. It tests communication, awareness, personality and clarity of goals.'
        },
        {
        ...
        {
            keywords: ['cat online', 'online exam', 'computer based'],
        ...
        {
            keywords: ['mba partner cat', 'mba partner course', 'cat course'],
            answer: 'MBA Partner offers structured CAT prep support including live projects, mentorship, mock GDPIs and resume building alongside your CAT journey.'
        },
    ],
    mba: [
        {
        ...
        },
        {
            ...
            answer: 'Live projects allow you to work on real business problems under industry mentors, helping strengthen your CV and interview preparation.'
        },
        {
        ...
        {
            keywords: ['personal interview', 'pi'],
            answer: 'MBA interviews test academics, work experience, current affairs, personality, goals and communication skills.'
        },
        {
        ...
        {
            keywords: ['executive mba', 'emba', 'working professional'],
        ...
        {
            keywords: ['hr interview', 'behavioural interview'],
        ...
        {
            keywords: ['pre placement talk', 'ppt'],
        ...
        {
            keywords: ['lateral placement', 'lateral'],
        ...
        {
            keywords: ['certifications', 'courses'],
        ...
        // MBA Partner specific
        {
            keywords: ['mba partner', 'about mba partner'],
            answer: 'MBA Partner is a platform that helps MBA students and aspirants through live projects, case competitions, mentorship, placement prep and CAT/OMET guidance.'
        },
        {
            keywords: ['mentor', 'mentorship'],
            answer: 'Our mentors are experienced professionals and MBA alumni who guide you through live projects, interview prep, CV reviews and career planning.'
        },
        {
            keywords: ['contact', 'call', 'whatsapp', 'reach out'],
        ...
        {
            keywords: ['What does the GDPI round cover'],
            answer: 'The GDPI process typically includes a Group Discussion (GD), a Personal Interview (PI), and sometimes a Written Ability Test (WAT). It evaluates your communication skills, academic background, work experience, current affairs awareness, leadership potential, and overall fit for a B-school.'
        },
        {
            keywords: ['Which OMET should I target?'],
...
const GREETINGS = {
    cat: "Hi! 👋 I'm the MBA Partner assistant. Ask me about CAT/OMETs prep, mock GDPIs, or our courses.",
    mba: "Hi! 👋 I'm the MBA Partner assistant. Ask me about live projects, case competitions, or placement prep.",
};

const SUGGESTIONS = {
    cat: ['How do I improve my DILR score?', 'What does the GDPI round cover?', 'Which OMET should I target?'],
    mba: ['How do live projects work?', 'What is the Placements Bootcamp?', 'How do I get a mentor?'],
};

const FALLBACK =
    "Sorry, I couldn't find an exact answer. You can ask me about CAT preparation, VARC, DILR, Quant, GDPI, MBA admissions, live projects, case competitions, placements, resumes, internships, or course details. For personal guidance, call or WhatsApp us at +91 70427 32092.";
// Simple keyword-overlap matcher — no AI, fully offline.
function findAnswer(track, text) {
    const lower = text.toLowerCase();
    const kb = KNOWLEDGE_BASE[track] || KNOWLEDGE_BASE.cat;
    let best = null;
    let bestScore = 0;
...
function ChatbotWidget({ track }) {
    ...
    function toggleOpen() {
        ...
        if (next && !opened) {
            setOpened(true);
            setMessages([{ role: 'bot', text: GREETINGS[track] || GREETINGS.cat }]);
        }
    }
    ...
    function send(text) {
        ...
        if (!trimmed) return;
        setInput('');
        const answer = findAnswer(track, trimmed);
        setMessages((prev) => [...prev, { role: 'user', text: trimmed }, { role: 'bot', text: answer }]);
    }

    const suggestions = SUGGESTIONS[track] || SUGGESTIONS.cat;
...
function mountChatbot() {
    ...
    root.render(<ChatbotWidget track={track} />);
}
